...
/**
 * @brief 获取遥控器当前数据指针(TEMP数组),供其他模块读取摇杆/开关等原始值
 * @note  返回rc_ctrl[TEMP],内容随SBUS接收实时更新;未初始化时返回NULL
 * @return RC_ctrl_t* 当前遥控器数据指针,可能为NULL
 */
RC_ctrl_t *RemoteControlGetData();
